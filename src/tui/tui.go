...
func StartTui(journal chan pinger.Ping) {
	fmt.Println("tui")
	//err := tui.Init()
	//if err != nil {
	...
	//plot.Title = "Ping time"
	//plot.SetRect(0, 0, 50, 15)
	//plot.Marker = widgets.MarkerDot
	//plot.Data = [][]float64{[]float64{1, 2, 3, 4, 5}}
	...
	//l.Rows = listData
	//l.SetRect(0, 5, 25, 12)
	//l.TextStyle.Fg = tui.ColorYellow
	//
	//g := widgets.NewGauge()
	//g.Title = "Gauge"
	//g.Percent = 50
	...
	//g.BorderStyle.Fg = tui.ColorWhite
	...
	//sl.LineColor = tui.ColorCyan
	//sl.TitleStyle.Fg = tui.ColorWhite
	//
	//sl2 := widgets.NewSparkline()
	//sl2.Title = "srv 1:"
	//sl2.Data = sparklineData
	//sl2.TitleStyle.Fg = tui.ColorWhite
	//sl2.LineColor = tui.ColorRed
	//
	...
	//lc.AxesColor = tui.ColorWhite
	//lc.LineColors[0] = tui.ColorRed
	...
	//bc.BarColors[0] = tui.ColorGreen
	//bc.NumStyles[0] = tui.NewStyle(tui.ColorBlack)
	//
	//lc2 := widgets.NewPlot()
	...
	//lc2.AxesColor = tui.ColorWhite
	//lc2.LineColors[0] = tui.ColorYellow
	//
	//p2 := widgets.NewParagraph()
	//p2.Text = "Hey!\nI am a borderless block!"
	//p2.Border = false
	//p2.SetRect(50, 10, 75, 10)
	//p2.TextStyle.Fg = tui.ColorMagenta
	//
	//draw := func(count int) {
	//	g.Percent = count % 101
	...
	//
	//	tui.Render(p, l, g, slg, lc, bc, lc2, p2)
	//}
	//
	//tickerCount := 1
	//draw(tickerCount)
